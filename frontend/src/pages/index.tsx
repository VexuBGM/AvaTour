  ...
  return (
    <div className="h-screen">
      <div className="h-full">
        <img className="w-1/5" src="/images/landing-page-planet.png" draggable="false"/>
      ...
      <div className="z-10 h-1/3 w-full top-64 absolute">
        <div className="left-56 bottom-0 h-36 w-fit absolute flex flex-col justify-between">
          <div className="shadow-ycustom w-full rounded-xl cursor-pointer" style={{ background: 'var(--ybtn-color)'}}>
